...
def checkvalid(passport):
    ...
    return (
        byr_validate(passport.get('byr')) and
        iyr_validate(passport.get('iyr')) and
        eyr_validate(passport.get('eyr')) and
        hgt_validate(passport.get('hgt')) and
        hcl_validate(passport.get('hcl')) and
        ecl_validate(passport.get('ecl')) and
        pid_validate(passport.get('pid'))
    )
